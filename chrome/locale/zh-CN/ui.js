Zotero.Jasminum.UI = new function() {
    ...
    this.displayMenuitem = function() {
        ...
        var showName = items.some((item) => this.UI.isCNKIName(item));
        pane.document.getElementById("jasminum-popup-menu2").hidden = !showName; // 小工具弹出菜单
        ...
        if (items.length === 1) {
            ...
            pane.document.getElementById("jasminum-itemmenu-bookmark").hidden = !showBookmark;
        }
